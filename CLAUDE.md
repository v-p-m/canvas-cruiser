...
of `game.js` or `screens.js` and say so in their header block; where one
deliberately diverged from what it replaced, that is the entry below.
[PORTING.md](PORTING.md) has the step-by-step reasoning.
